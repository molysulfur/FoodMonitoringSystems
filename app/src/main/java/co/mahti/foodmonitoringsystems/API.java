...
public interface API {
    ...
    @GET("gtin/v2_0/?upcCode=8850999320007%20&field_names=all&language=en&app_key=/y7bYcVpFI7B&signature=aor+VLZhqT2G7HYPY2VO8cn22Po=")
    Call<Upcbarcode> getUpcCode();
   /* Call<Upcbarcode> getUpcCode(@Query("upcCode") String text,
